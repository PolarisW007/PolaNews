...
export const PRESET_FEEDS: PresetFeed[] = [
  ...
  {
    title: '界面新闻',
    url: 'https://plink.anyfeeder.com/jiemian/news',
  ...
  {
    title: '南方周末 新闻',
    url: 'https://plink.anyfeeder.com/infzm/news',
    site_url: 'https://www.infzm.com',
    language: 'zh',
    category: 'society',
  },
  {
    title: '南方周末 推荐',
    url: 'https://plink.anyfeeder.com/infzm/recommends',
    site_url: 'https://www.infzm.com',
    language: 'zh',
    category: 'society',
  },
